...
def sanitize_material_filename(filename: str) -> str:
    ...
    try:
        safe_name = file_security.sanitize_upload_filename(filename)
    except ValueError as exc:
        raise MaterialUploadError("invalid local material filename") from exc
    if safe_name.lower().startswith(_INTERNAL_UPLOAD_PREFIX):
