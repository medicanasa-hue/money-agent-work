...
class TestTaskService(unittest.TestCase):
    ...
    def test_generate_subtitle_uses_custom_audio_fallback_without_sub_maker(self):
        """
    ...
    def test_generate_subtitle_falls_back_when_edge_has_no_output(self):
        """
        ...
        whisper_create.assert_called_once()
        whisper_correct.assert_called_once()
    ...
    def test_start_records_unexpected_pipeline_exception(self):
        ...
        self.assertEqual(
            failed_task["error"],
            "RuntimeError: unexpected task failure",
        )
